...
```bash
git clone https://github.com/InfiXAI/dual_agents_training.git
cd dual_agents_training
sbatch --nodes=2  --job-name=summary  submit_2nodes.sh run_agent_summary_sbatch_router.sh
sbatch --nodes=2  --job-name=retool  submit_2nodes.sh run_agent_retool_sbatch_router.sh
```
